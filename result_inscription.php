...
if(isset($_POST["login"]) && isset($_POST["nom"]) && isset($_POST["prenom"]) && isset($_POST["email"])
	...
	if(Utilisateur::getUtilisateurFromLogin($_POST["login"]) != NULL){
		echo $_POST["login"]."exsites, utilise d'ature login, retour vers la page d'inscription";
		echo '<a href="inscription.php">back</a>';
	}elseif($_POST["mdp"] != $_POST["mdp2"]){
		echo "les deux mots de passe ne sont pas identiques";
		echo '<a href="inscription.php">back</a>';
	}else{
		Utilisateur::insererUtilisateur($_POST["login"], $_POST["mdp"], $_POST["nom"], $_POST["prenom"], $_POST["promotion"], $_POST["email"], $_POST["presentation"]);
